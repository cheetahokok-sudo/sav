...
export const metadata: Metadata = {
  ...
  description:
    "เลือกเครื่องจักรที่มอเตอร์ขับอยู่ (ปั๊มหอยโข่ง ปั๊มแนวแกน พัดลม สายพานลำเลียง เครื่องอัดอากาศสกรูและลูกสูบ เครื่องบด รอก/เครน) แล้วดูว่าต้องมีฟังก์ชันป้องกันอะไรบ้าง จำเป็น แนะนำ หรือใช้เฉพาะบางระบบ พร้อมอาการเสียที่แต่ละฟังก์ชันจับได้ และข้อจำกัดที่กระแสมองไม่เห็น",
